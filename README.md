...
4. The activities in the data set are named with the descriptive labels<br><br>
5. A second independent tidy data set is created, which provides the average of each variable for each activity and each subject.<br><br>
